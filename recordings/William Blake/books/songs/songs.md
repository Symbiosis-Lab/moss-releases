...
- *copy-z-bound/* — **Copy Z** (Library of Congress, Rosenwald). 35 openings of the bound volume photographed as bound (each file shows the verso of one leaf + recto of the next). The late combined binding, fully coloured.

- *innocence/* — per-plate scans of *Songs of Innocence* (27 plates) from an earlier acquisition, plus `innocence-text.md` (full plate-text transcription from Project Gutenberg).

- *experience/* — `experience-text.md` (full plate-text transcription). Per-plate scans now available in the three new copy folders above.
...
Blake printed *Songs* over the long arc of his working life. The book changed in his hands and again after them. Reading across the four copies is the historical experience of meeting the actual artifact rather than the modern reprint of one frozen state.

## Source

The William Blake Archive (eds. Eaves / Essick / Viscomi) at the University of North Carolina, under their research-use terms with attribution. URL pattern: `https://www.blakearchive.org/images/songsie.<copy>.p<N>.300.jpg` for each copy.
